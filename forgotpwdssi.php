...
if(isset($_POST['submit'])){
 ...
 if($pwd == $rpwd)
 {
  $sql="UPDATE ssidetails SET password='$pwd' WHERE email='$eml'";
...
<h2><i><b><center>SmallSacle Industries Forgot Password?</i></b></center></h2>

<form action="forgotpwdssi.php" method="post">
