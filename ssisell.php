...
if($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  if(preg_match("!image!",$_FILES['img']['type']))
  {
   if(copy($_FILES['img']['tmp_name'],$image_path))
   {
    ...
    $sql="INSERT into sellingitems(sellerid,price,description,category,image,who)"."values('$seller','$price','$description','$category','$image_path','company')";
...
<body>
<form action="ssisell.php" method="post" enctype="multipart/form-data">
  <div class="container">
